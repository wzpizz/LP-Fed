...
class Data():
    ...
    def transform(self):
        ...
        if self.color_jitter:
            transform_train = [transforms.ColorJitter(brightness=0.1, contrast=0.1, saturation=0.1,
                                                      hue=0)] + transform_train
    ...
    def preprocess_train(self):
        ...
        return self.train_dataset_sizes
    ...
    def preprocess_test(self):
        ...
        for test_dir in self.datasets:
            test_dir = '../../../../../../data/easyfl/' + test_dir + '/pytorch'
            dataset = test_dir.split('/')[8]
            # test_dir = '../../../data/' + test_dir + '/pytorch'
            # dataset = test_dir.split('/')[4]
