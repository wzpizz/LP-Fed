...
parser.add_argument('--project_dir',default='/home/lizeyu/easyfl/applications/fedreid/FedReID-master', type=str, help='project path')
parser.add_argument('--data_dir',default='../../../../../../data/easyfl',type=str, help='training dir path')
parser.add_argument('--datasets',default='Market,cuhk03-np-detected,cuhk01,MSMT17,viper,prid,3dpes,ilids',type=str, help='datasets used')
...
parser.add_argument('-et', type=float, default=1.0)
...
def train():
    ...
    for i in range(rounds):
        ...
        if (i+1)%10== 0:
            server.localmodeltest(use_cuda)
            if args.kd:
